  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      <div class="col-sm-5 m-b-xs">
        <form action="<%=path %>/admin/backproductList.do" method="post" id="searchform" name="searchform">
        ...
        <c:forEach items="${list}" var="backproduct" varStatus="status">
          <tr>
            ...
            <c:if test="${backproduct.shstatus eq '待审核'}">
              <a href="updatebacksh.do?id=${backproduct.id}&type=ty"  class="active" ui-toggle-class="">同意退货</a>
              <a href="updatebacksh.do?id=${backproduct.id}&type=jj"  class="active" ui-toggle-class="">拒绝退货</a>
            </c:if>
              <a href="backproductDel.do?id=${backproduct.id}" title="删除" class="active" ui-toggle-class=""><i class="fa fa-times text-danger text"></i></a>
            </td>
          </tr>
        </c:forEach>
        </tbody>
